                        ...
                        >
                          {
                            ...
                            <>
                              <Box>{onlinerMap[peer]?.bns || peerMap.get(peer)?.bns || onlinerMap[peer]?.ens || peerMap.get(peer)?.name || formatAddress(peer)}</Box>
                              <Box>You</Box> 
                            </> :
                            <>
                  ...
                  <Box>
                      {
                        peers.map((peer) => (
                          <Flex 
                            ...
                            <Box>
                              {
                                onlinerMap[peer.address]?.bns || 
                                peerMap.get(peer.address)?.bns || 
                                onlinerMap[peer.address]?.name || 
